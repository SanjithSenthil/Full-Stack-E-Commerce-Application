...
{	// Load driver class
	...
	{			
		...
		while (rst.next()){
            %>
            <h2 style="text-align: center;"><%= rst.getString(2) %></h2>
            <img style="display: block; margin: 0 auto;" src="../<%= rst.getString(4) %>" alt="Product Image">
            ...
            <h3 style="text-align: center;"><a href="addcart.jsp?id=<%= rst.getInt(1) %>&name=<%= rst.getString(2) %>&price=<%= rst.getDouble(3) %>">Add to Cart</a></h3>
            <h3 style="text-align: center;"><a href="listprod.jsp">Continue Shopping</a></h3>
            <%
		}
	}
